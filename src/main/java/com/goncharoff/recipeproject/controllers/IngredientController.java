...
import com.goncharoff.recipeproject.services.IngredientService;
import com.goncharoff.recipeproject.services.RecipeService;
import com.goncharoff.recipeproject.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    public String listIngredients(@PathVariable String recipeId, Model model) {
        log.debug("Getting ingredient list with id: " + recipeId);
    ...
    public String updateRedipeIngredient(@PathVariable String recipeId, @PathVariable String id,
                                         Model model) {
        model.addAttribute("ingredient", ingredientService.findByRecipeAndIngredientId(Long.valueOf(recipeId), Long.valueOf(id)));
    ...
    public String saveOfUpdate(@ModelAttribute IngredientCommand ingredientCommand) {
        ...
        log.debug("Saved intedient with id " + savedCommand.getId());
